...
var levels={"Reading":{"0":0,"L":2,"W":4,"S":6,"P":8},"English":{"Rung1":0,"Rung2":1,"Rung3":2,"Rung4":3,"Rung5":4},"NNG":{"Rung1":0,"Rung2":1,"Rung3":2,"Rung4":3,"Rung5":4},"NNG3":{"Rung1":0,"Rung2":1,"Rung3":2,"Rung4":3,"Rung5":4},"Ramanagaraa-NNG1":{"Rung1":0,"Rung2":1,"Rung3":2,"Rung4":3,"Rung5":4},"Ramanagara-NNG2":{"Rung1":0,"Rung2":1,"Rung3":2,"Rung4":3,"Rung5":4},"Target":{"Rung1":0,"Rung2":1,"Rung3":2,"Rung4":3,"Rung5":4},"SSLC":{"Rung1":0,"Rung2":1,"Rung3":2,"Rung4":3,"Rung5":4},"Anganwadi":{"General awareness":0,"Gross motor":1,"Fine motor":2,"Language":3,"Intellectual":4,"Socio-emotional":5,"Pre-academic":6}};

var timeLabel= {"1":{"Pre test":0,"Post test":4},"2":{"20th day test":0,"60th day test":4},"3":{"20th day test":0,"60th day test":4},"4":{"Pre test":0,"Post test":4},"5":{"Baseline":0,"15th day test":4,"30th day test":8,"45th day test":12},"6":{"Pre test":0,"Post test":4},"7":{"Pre test":0,"Post test":4},"8":{"Pre test":0,"Post test":4},"9":{"Pre test":0,"Post test":4}};
...
function analyticsdata(divtype,programme)
{
  ...
  {    
    for(category in info["analytics"][num])
    {
      ...
      divs=divs+'<div id=\"'+divtype+'-analytics-'+category+'\" class=\"'+classtype+'\" style=\"height:500px\"><p align=\"right\"><a href=\"#top\">Back to Top</a></p><p align=\"center\"><b>'+category+'</b></p><div id=\"'+divtype+'-'+category+'-legend\" class=\"rightside\"></div><div id=\"'+divtype+'-'+category+'-content\" class=\"leftside\"  style=\"height:300px; width:400px\"></div></div>'
      count=count+1;
    }
  }
  ...
  for( category in info["analytics"][num])
  {
    levelbar(divtype,programme,info["analytics"][num],category)
  }
 }
}
...
function preschoollevelbar(programme,assesstype,category)
{
  ...
  for( type in assesstype[category])
  {
    ...
    data.push({label:type,data:dataplot,bars:{barWidth:0.2, show:true,horizontal:true,align:align[count-1]},color:color[type]});
    count=count+1;
  }
  ...
  $.plot(document.getElementById(id), data,{yaxis:{ticks:y_axis,autoscaleMargin:0.0},xaxis:{autoscaleMargin:0.0},legend:{show:true,container:document.getElementById("preschool-"+category+"-legend")}});
...
function levelbar(divtype,programme,assesstype,category)
{
  ...
  $.plot(document.getElementById(id), data,{xaxis:{ticks:x_axis,autoscaleMargin:0.0},yaxis:{autoscaleMargin:0.0},legend:{show:true,container:document.getElementById(divtype+"-"+category+"-legend")}});

}

function preschoolprogressdata(pid,programme)
{
  document.getElementById("preschool-progress").innerHTML='<p align=\"center\"><b>Progress performance for '+info["name"]+' (Average Scores)</b></p><div id=\"preschool-progress-content\" class=\"leftside\" style=\"height:400px; width:550px\"></div><br><br><div id=\"preschool-progress-legend\" class=\"rightside\"></div>'
  ...
  $.plot(document.getElementById(id), data,{yaxis:{ticks:y_axis,autoscaleMargin:0.0},xaxis:{min:0,autoscaleMargin:0.0},legend:{show:true,container:document.getElementById("preschool-progress-legend")}});

}

function progressdata(divtype,pid,programme)
{
  document.getElementById(divtype+"-progress").innerHTML='<p align=\"center\"><b>Progress performance for '+info["name"]+'</b></p><div id=\"'+divtype+'-progress-content\" class=\"leftside\" style=\"height:400px; width:550px\"></div><br><br><div id=\"'+divtype+'-progress-legend\" class=\"rightside\"></div>'
  ...
  $.plot(document.getElementById(id), data,{xaxis:{ticks:x_axis},legend:{show:true,container:document.getElementById(divtype+"-progress-legend")}});
