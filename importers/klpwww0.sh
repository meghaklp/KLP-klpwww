...
# Setup dblink
sudo -u postgres psql -d ${DBNAME} -f /usr/share/postgresql/8.3/contrib/dblink.sql
...
sudo -u postgres psql -d ${DBNAME} -f /usr/share/postgresql-8.3-postgis/spatial_ref_sys.sql
# Grant privileges
